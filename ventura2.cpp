...
void choose2ToSum( const vector<int>& v,  const int sum ){
    int n = v.size(), cnt = 0;
    for( int i = 0; i < n; i++ )
        for( int j = i+1; j < n; j++)
            if( v[i]+v[j] == sum ){
...
void choose3ToSum( const vector<int>& v,  const int sum ){
    int n = v.size(), cnt = 0;
    for( int i = 0; i < n; i++ )
        for( int j = i+1; j < n; j++)
            for( int k = j+1; k < n; k++ )
...
void choose4ToSum( const vector<int>& v,  const int sum ){
    int n = v.size(), cnt = 0;
    for( int i = 0; i < n; i++ )
        for( int j = i+1; j < n; j++)
            for( int k = j+1; k < n; k++ )
